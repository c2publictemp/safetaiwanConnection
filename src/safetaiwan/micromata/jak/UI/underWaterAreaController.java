...
public class underWaterAreaController extends AnchorPane {
	...
	void initialize() {
		...
		FTPClientUpload.uploadFileToFTP(serverIP, "sowlu", "710522", CommonTools.appLocation()+"\\resources\\exampledata\\index_red.html", "index.html");;
//		try {
//			Thread.sleep(100);
...
//		System.out.println("hello world");
		...
		FTPClientUpload.uploadFileToFTP(serverIP, "sowlu", "710522", CommonTools.appLocation()+"\\resources\\exampledata\\index.html", "index.html");;
		webViewInitial();
	...
	private void comboBoxRegionSelect() {
		...
		regionNameComboBox.valueProperty().addListener(new ChangeListener<String>() {
			...
			public void changed(ObservableValue ov, String t, String t1) {
				...
				s = df.format(x);
				cEdgeLabel.setText(s + "(公里)"+" 節點:"+(c.size()-1)+"個");
			}
		});
	...
	private void webViewInitial() {
		...
		webEngine.load("http://"+serverIP+"/index.html");
